...
class BottomBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int counter = context.watch<HomeIndexCubit>().state.counter;
        ...
        child: Stack(
          children: [
            ...
            _iconContainer(
                ...
                CustomIcons.menu_basket_icon__large,
                counter),
            _iconContainer(
                context,
                4,
  ...
  _iconContainer(BuildContext context, int index, double location, Widget icon,
      int counter) {
    return AnimatedPositioned(
      duration: _animationDuration,
      bottom: counter == index ? 50.smh : 15.smh,
      left: location.w,
      child: InkWell(
        onTap: () {
        ...
        child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color:
                  counter == index ? CustomColors.primary : Colors.transparent,
